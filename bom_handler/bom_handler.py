...
class BOMHandler:
    ...
    target_headers = ["Qty", "Reference"] # target headers
    data_array = []

    def __init__(self, dir_path="", target_headers=target_headers, csv_mouser_column_name="MFN"):
        self.csv_partnumber_column_name = csv_mouser_column_name    # get user partnumber string from bom ... 
        self.target_headers.append(self.csv_partnumber_column_name) # and append to headers
        if (dir_path == ""):
