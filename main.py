...
CSV_MOUSER_COLUMN_NAME = "MNR"                       # how you named your column
...
part_order_multiplier = 1                               # multiply by pcbs ordered
...
class MouserOrderClient:
    ...
    def order_parts_from_data_array(self, data_array):
        ...
        for idx, row in df.iterrows():
            parts_json.append({'MouserPartNumber': row[headers[0]], 'Quantity': int(row[headers[1]])*part_order_multiplier, 'CustomerPartNumber':row[headers[2]]})
